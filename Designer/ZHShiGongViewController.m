...
@interface ZHShiGongViewController ()
{
    UITableView *tb;
...
@implementation ZHShiGongViewController
...
- (void)loadConstructionsData
{
    ...
    NSMutableString *urlStr = [NSMutableString stringWithFormat:@"%@/ZaiShi", KHomeUrl];
    ...
    [manager POST:urlStr parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        dict = dict[@"ArrayOfZaiShi"][@"ZaiShi"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    headerView.backgroundColor= [UIColor colorWithPatternImage:[UIImage imageNamed:@"施工统计-表格title"]];
    return headerView;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    l1.text = dict [@"SubCityCode"][@"text"];
    l2.text = dict [@"SubCityName"][@"text"];
    l3.text = dict [@"ZaiShiShu"][@"text"];
    l4.text = dict [@"ZhongQi"][@"text"];
    l5.text = dict [@"BaoJing"][@"text"];
    l6.text = dict [@"FaKuan"][@"text"];
